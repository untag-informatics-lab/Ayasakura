...
DEBUG_PROPAGATE_EXCEPTIONS  = envbool('DEBUG_PROPAGATE_EXCEPTIONS', 'True') #Dev is False
DEBUG                       = envbool('DEBUG', 'True') #Dev is False
...
CSRF_COOKIE_SECURE              = envbool('CSRF_COOKIE_SECURE', 'False') #Dev is False
...
STATIC_ROOT                     = '/var/www/Ara/assets/statics/'
MEDIA_ROOT                      = '/var/www/Ara/assets/media/'
STATIC_URL                      = '/static/'
MEDIA_URL                       = '/media/'
